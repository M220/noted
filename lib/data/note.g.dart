...
Note _noteDeserializeWeb(IsarCollection<Note> collection, Object jsObj) {
  /*final object = Note(IsarNative.jsObjectGet(jsObj, r'title') ?? '',IsarNative.jsObjectGet(jsObj, r'details') ?? '',);object.id = IsarNative.jsObjectGet(jsObj, r'id') ;*/
  //return object;
